...
import { createAccessTolken, createRefreshToken, getRefreshTokenExpiry, hashToken, verifyRefreshToken, } from "../utils/token.js";
...
export class AuthService {
    ...
    async login(input) {
        ...
        await this.sessionRepository.updateRefreshToken(session.id, refreshTokenHash);
        return {
            accessToken,
            refreshToken,
            user: {
    ...
    async refresh(refreshToken) {
        ...
        await this.sessionRepository.updateRefreshToken(session.id, newRefreshTokenHash);
        return {
            accessToken,
