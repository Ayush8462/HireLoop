import { z } from "zod";
const emptyStringToUndefined = (value) => typeof value === "string" && value.trim() === ""
    ? undefined
    : value;
const optionalString = (schema) => z.preprocess(emptyStringToUndefined, schema.optional());
const optionalNumber = (schema) => z.preprocess(emptyStringToUndefined, z.coerce.number().pipe(schema).optional());
/**
...
const createProfileFields = {
    ...
    designation: optionalString(z
        .string()
        .trim()
        .max(150, "Designation cannot exceed 150 characters")),
    experienceYears: optionalNumber(z
        .number()
